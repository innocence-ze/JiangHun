...
namespace BlendModes
{
    ...
    public class BlendModeEffectEditor : Editor
    {
        ...
        private SerializedProperty componentExtensionProperty;

        private Editor componentExtensionEditor;
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (componentExtensionEditor)
                componentExtensionEditor.OnInspectorGUI();
        }
        ...
        {
            if (!ComponentExtension || ComponentExtension.GetSupportedShaderFamilies().Length == 1) return;

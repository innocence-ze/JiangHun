...
namespace BlendModes
{
	...
	public class BlendModeEffect : MonoBehaviour
	{
		...
		public BlendMode BlendMode
		{
			...
			set { SetBlendMode(value, RenderMode, SelectiveBlending); }
		}
		...
		public RenderMode RenderMode
		{
			...
			set { SetBlendMode(BlendMode, value, SelectiveBlending); }
		}

		/// <summary>
		/// Whether object is in selective blending mode.
		/// </summary>
		public bool SelectiveBlending
		{
			get { return _selectiveBlending; }
		...
		[SerializeField]
		private bool _selectiveBlending = false; // currently disabled, WIP
		[SerializeField]
		...
		public void SetBlendMode (BlendMode blendMode, RenderMode renderMode = RenderMode.Grab, bool selectiveBlending = false)
		{
			...
			if (renderMode == RenderMode.UnifiedGrab) selectiveBlending = false;
		...
		public void OnEnable ()
		{
			...
			SetBlendMode(BlendMode, RenderMode, SelectiveBlending);
		}
		...
		public void OnDisable ()
		{
			...
			Material = BlendMaterials.GetMaterial(ObjectType, RenderMode.Grab, BlendMode.Normal, false);

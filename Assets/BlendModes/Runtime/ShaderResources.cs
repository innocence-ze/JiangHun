...
namespace BlendModes
{
    ...
    public sealed class ShaderResources : ScriptableObject
    {
        ...
        /// <summary>
        /// Loads an <see cref="ShaderResources"/> asset instance from the project resources.
        /// </summary>
        ...
        /// </summary>
        public IEnumerable<string> GetShaderFamilies ()
        {
            return GetShaders().Select(s => GetShaderFamily(s.name));
        }
